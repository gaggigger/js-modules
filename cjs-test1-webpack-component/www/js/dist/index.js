...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * Modified by Carsten Schneider, Shopgate GmbH
	 *
	 */
	        ...
	        handler: function (ev) {
	            ...
	            switch (ev.type) {
	                ...
	                case 'touchend':
	                    ...
	                    if (opa >= 1) {
	                        if (posX > 0) {
	                            panes.eq(current_pane).animate({"transform": "translate(" + (pane_width) + "px, " + deltaY + "px) rotate(10deg)", opacity: 0}, $that.settings.animationSpeed, function () {
	                                if($that.settings.onLike) {
	                                    $that.settings.onLike(panes.eq(current_pane));
	                                }
	                                $that.next();
